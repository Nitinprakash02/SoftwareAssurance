...
int main() {
    ...
    std::cout << "Inserting elements into the Red-Black Tree.\n";
    int elements[] = {8, 18, 5, 15, 17, 25, 40, 80};
    for (int elem : elements) {
        rbTree.insert(elem);
        std::cout << "Inserted " << elem << " into the Red-Black Tree.\n";
    }
    ...
    if (rbTree.validateRBProperties()) {
        std::cout << "The tree maintains Red-Black properties after insertion.\n";
    } else {
        std::cout << "Red-Black properties violated after insertion.\n";
    }
    ...
    // Deleting a node
    int deleteKey = 18;
    std::cout << "\nDeleting node with key " << deleteKey << " from the Red-Black Tree.\n";
    rbTree.deleteNode(deleteKey);

    // Printing the tree after deletion
    std::cout << "Red-Black Tree after deleting " << deleteKey << ":\n";
    rbTree.printTree();

    // Validating Red-Black Tree properties again after deletion
    if (rbTree.validateRBProperties()) {
        std::cout << "The tree maintains Red-Black properties after deletion.\n";
    } else {
        std::cout << "Red-Black properties violated after deletion.\n";
    }

    // Demonstrating the minimum and maximum functions
    std::cout << "\nMinimum value in the Red-Black Tree: " << rbTree.minimum(rbTree.getRoot())->data << std::endl;
    std::cout << "Maximum value in the Red-Black Tree: " << rbTree.maximum(rbTree.getRoot())->data << std::endl;
